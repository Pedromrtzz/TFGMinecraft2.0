    ...
    // GREEN TEA SHOP
        ...
        // MOCHI FRESA
            ...
            public static final RegistryObject<Item> MOCHI_FRESA = ITEMS.register("mochi_fresa",
                    () -> new BlockItem(ModBlocks.MOCHI_FRESA.get(), new Item.Properties()
                            .food(ModFoodPropierties.MOCHI_FRESA))
            );
        ...
        // MOCHI CHOCOLATE
            ...
            public static final RegistryObject<Item> MOCHI_CHOCOLATE = ITEMS.register("mochi_chocolate",
                    () -> new BlockItem(ModBlocks.MOCHI_CHOCOLATE.get(), new Item.Properties()
                            .food(ModFoodPropierties.MOCHI_CHOCOLATE))
            );
