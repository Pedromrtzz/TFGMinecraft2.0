...
public class ModFoodPropierties {
    ...
    public static final FoodProperties ARROZ_POLLO = new FoodProperties.Builder().nutrition(2).saturationModifier(0.2F)
            .build();

    public static final FoodProperties ARROZ_VERDURAS = new FoodProperties.Builder().nutrition(2).saturationModifier(0.2F)
            .build();
